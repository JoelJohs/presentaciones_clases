...
| **Control de Ventanas** | **Win + D** | Muestra el Escritorio (esconde todo). |
| **Control de Ventanas** | **Alt + Tab** | Cambia rápidamente entre ventanas abiertas. |
| **Control de Ventanas** | **Win + Flechas** | Mueve y ajusta la ventana a la mitad de la pantalla. |
| **Control de Ventanas** | **Alt + F4** | Cierra la ventana o programa actual. |
| **Edición y Texto** | **Ctrl + C** / **Ctrl + V** | Copiar y Pegar texto o archivos. |
| **Edición y Texto** | **Ctrl + X** | Cortar (mueve el texto o archivo de lugar). |
| **Edición y Texto** | **Ctrl + Z** / **Ctrl + Y** | Deshacer y Rehacer la última acción. |
| **Edición y Texto** | **Ctrl + A** | Seleccionar todo el texto o archivos del directorio. |
| **Edición y Texto** | **F2** | Cambiar el nombre al archivo seleccionado. |
| **Navegador y Web** | **Ctrl + T** / **Ctrl + W** | Abre una nueva pestaña / Cierra la pestaña actual. |
| **Navegador y Web** | **Ctrl + Shift + T** | Reabre la última pestaña que cerraste por error. |
| **Herramientas** | **Ctrl + Shift + Esc** | Abre el Administrador de Tareas (tu salvavidas). |
| **Herramientas** | **Win + Shift + S** | Captura de pantalla directa (Herramienta de Recortes). |
